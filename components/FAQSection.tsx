...
const FAQ = {
  ...
  items: [
    ...
    {
      q: "割引率は一律40%ですか？",
      a: "一律ではありません。社員優待により、施術メニューに応じて10〜45%OFFの割引が適用されます。対象メニューや時期により割引率が異なるため、最新の適用条件はお問い合わせください。",
    },
    {
      q: "社員数が少ないのですが、導入できますか？",
      a: "はい、可能です。少人数の企業様でも導入いただけます。導入費用0円で、社員全員が優待価格（10〜45%OFF）の対象となるため、利用人数が少ない場合でも導入しやすい設計です。",
    },
    {
      q: "男性社員も利用できますか？",
