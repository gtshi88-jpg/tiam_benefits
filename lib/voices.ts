...
export const VOICES_LIST: VoiceItem[] = [
  ...
  },
  {
    ...
    body: `株式会社サンプルBは、教育・人材業界で幅広い事業を展開しています。採用競争が激化する中、福利厚生の差別化が課題となっていました。「TIAM BENEFITS」の導入により、美容医療という新しい切り口で社員満足度を高め、採用・定着の両面で効果を感じています。月額定額で人数無制限という手軽さも、導入の決め手となりました。`,
  },
  {
    id: "3",
    company: "株式会社サンプルC",
    ...
    body: `株式会社サンプルCは、小売・サービス業界で複数ブランドを展開しています。業界全体で人手不足が深刻化する中、従業員の満足度向上と採用差別化が重要な経営課題でした。「TIAM BENEFITS」は、銀座のクリニックという信頼感のある提供元と、月額16,500円の定額料金が魅力でした。社員からは「自分磨きの機会が増えた」「働くモチベーションが上がった」という声が多く寄せられています。`,
  },
  {
    id: "4",
    company: "株式会社サンプルD",
